...
flags.DEFINE_string(
    "train_tfexample",
    "/Users/sanqiang/git/ts/text_simplification_data/example_v0_val/*.example",
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            vars_to_hook = {
                ...
                "loss_syntax": outputs['loss_syntax']
            }
        ...
        for inst_id, result in enumerate(results):
            ...
            for gen_src_syntax_sent in gen_src_syntax_sents:
                ...
                for i, tag in enumerate(gen_src_syntax_sent.split()):
                    gen_src_syntax_sent_outputs[i] += '|' + tag if gen_src_syntax_sent_outputs[i] else tag
            ...
            for gen_trg_syntax_sent in gen_trg_syntax_sents:
                ...
                for i, tag in enumerate(gen_trg_syntax_sent.split()):
                    gen_trg_syntax_sent_outputs[i] += '|' + tag if gen_trg_syntax_sent[i] else tag
