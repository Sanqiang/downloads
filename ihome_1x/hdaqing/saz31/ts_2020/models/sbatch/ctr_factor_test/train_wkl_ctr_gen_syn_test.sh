...
#SBATCH --cluster=smp
#SBATCH --job-name=t_wkl_ctr_syn_gent
#SBATCH --output=t_wkl_ctr_syn_gent.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    --name wkl_ctr4_syn_gent \
    --mode train \
    --num_cpu 5 \
    --model_mode "t2t:bert_vocab" \
    --exp_dir "/zfs1/hdaqing/saz31/ts_exp/" \
    --train_tfexample "/zfs1/hdaqing/saz31/dataset/example_v7_val/shard_wikilarge_*.example" \
    --train_batch_size 64 \
    --dimension 256 \
    --num_hidden_layers 6 \
    --num_heads 4 \
    ...
    --init_ckpt_path "/zfs1/hdaqing/saz31/ts_exp/wkl_ctr_syn_gen_old/log/model.ckpt-820000"
