...
#SBATCH --job-name=e_all1_syn_gen
#SBATCH --output=e_all1_syn_gen.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    ...
    --control_mode "val:scatter_ppdb:syntax_gen" \
    --max_ppdb_len 100 \
    --beam_search_size 1 \
    --lr 0.1 \
    --num_ref 8 \
    ...
    --ppdb_vocab "/zfs1/hdaqing/saz31/dataset/rule_v1_val/vocab" \
