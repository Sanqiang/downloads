...
#SBATCH --gres=gpu:1
#SBATCH --job-name=t_wkiori_syn_gen_l3
#SBATCH --output=t_wkiori_syn_gen_l3.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    --name wkiori_syn_gen_l3 \
    --mode train \
    --num_cpu 3 \
    --model_mode "t2t:bert_vocab" \
    --exp_dir "/zfs1/hdaqing/saz31/ts_exp/" \
    --train_tfexample "/zfs1/hdaqing/saz31/dataset/example_v0_val/shard_wikilarge_ori_*.example" \
    --train_batch_size 48 \
    --dimension 256 \
    --num_hidden_layers 6 \
    --num_heads 4 \
    ...
    --syntax_level 3 \
    --init_ckpt_path "/zfs1/hdaqing/saz31/ts_exp/wkiori_syn_gen/ckpt/model.ckpt-533000"
